...
export type ProductIllustrationName =
  ...
  | 'product-invoice-pay-now'
  | 'product-invoice-price-increase'
  | 'product-invoice-calculator'
  | 'product-invoice-calendar'
  | 'product-invoice-ledger-connect'
  | 'product-invoice-qbo-xero'
  | 'product-invoice-payments-details-paid'
  // Proposals
  | 'product-proposal-signature-required'
  | 'product-proposal-payment-methods'
  | 'product-proposal-payment-methods-alt'
  | 'product-proposal-sent'
  | 'product-proposal-your-logo-left'
  | 'product-proposal-your-logo-right'
  | 'product-proposal-video'
  | 'product-proposal-add-service'
  | 'product-proposal-add-service-generic'
  | 'product-proposal-upsell-options'
  | 'product-proposal-pricing-intelligence'
  | 'product-proposal-price-insights-simple'
  // Engagement Letters
  | 'product-engagement-signature-required'
  | 'product-engagement-signed-terms'
  | 'product-engagement-placeholders'
  | 'product-engagement-sent'
  | 'product-engagement-terms-and-conditions'
  // In-App
  | 'product-in-app-billing-hub-payments'
  | 'product-in-app-billing-hub'
  | 'product-in-app-integrations'
  | 'product-in-app-dashboard'
  | 'product-in-app-trial-ending'
  | 'product-in-app-forms'
  | 'product-in-app-deals'
  | 'product-in-app-payments'
  // Emotive Icons
  ...
  | 'product-icon-pricing-correct'
  | 'product-icon-pricing'
  | 'product-icon-checklist'
  | 'product-icon-checklist-v2'
  // Payment Methods
  | 'product-payment-card'
  | 'product-payment-secure'
  | 'product-payment-card-paid-stamp'
  | 'product-payment-card-not-paid'
  | 'product-payment-card-warning'
  | 'product-payment-paid-stamp-pink'
  | 'product-payment-paid-stamp-purple'
  | 'product-payment-late-stamp-red'
  // Upsell Options
  | 'product-upsell-big-middle'
  | 'product-upsell-same-size'
  | 'product-upsell-with-space'
  // Advanced Branding
  | 'product-branding-landing-page'
  // Forms
  | 'product-forms-fill';
